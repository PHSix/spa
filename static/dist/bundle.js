...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Router\": () => (/* binding */ Router)\n/* harmony export */ });\n/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils.js */ \"./src/js/utils.js\");\n\n\n/**\n * Router 类\n * 1. routes  包含一个路由表(hashmap)，前进时候调用获取cb\n */\nclass Router {\n  constructor() {\n    this.routes = new Map();\n    this.current = \"/\";\n  }\n  init() {\n    this.addRoute(\"home\", () => __webpack_require__.e(/*! import() */ \"src_js_pages_home_js\").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/home.js */ \"./src/js/pages/home.js\")).then(_utils_js__WEBPACK_IMPORTED_MODULE_0__.useSetup));\n    this.addRoute(\"about\", () => __webpack_require__.e(/*! import() */ \"src_js_pages_about_js\").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/about.js */ \"./src/js/pages/about.js\")).then(_utils_js__WEBPACK_IMPORTED_MODULE_0__.useSetup));\n    // this.addRoute(\"home\", async () => console.log(import (\"./home.js\")))\n    // this.addRoute(\"about\", async () => console.log(import (\"./about.js\")))\n    if (\n      Array.from(document.body.children).findIndex(\n        (element) => element.getAttribute(\"id\") === \"app\"\n      ) === -1\n    ) {\n      (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.createApp)();\n    }\n    if (window.location.pathname === \"/\") {\n      this.push(\"home\");\n    } else {\n      this.push(window.location.pathname.slice(1));\n    }\n    window._router = this;\n  }\n  /**\n   *\n   * @param {string} path\n   * @param {Function} cb\n   */\n  addRoute(path, cb) {\n    this.routes.set(path, cb || function () {});\n  }\n  _clearApp() {\n    const app = document.getElementById(\"app\");\n    app.parentNode.removeChild(app);\n    (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__.createApp)();\n  }\n  push(path) {\n    this._clearApp();\n    // window.onpopstate = this.routes.get(path);\n    window.history.pushState(null, null, path);\n    // window.onpopstate = null;\n    this.routes.get(path)();\n  }\n}\n\n\n//# sourceURL=webpack://spa/./src/js/router.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"createApp\": () => (/* binding */ createApp),\n/* harmony export */   \"useSetup\": () => (/* binding */ useSetup)\n/* harmony export */ });\nconst createApp = function (style) {\n  const app = document.createElement(\"div\");\n  app.setAttribute(\"id\", \"app\");\n  app.setAttribute(\"class\", style || \"flex-center\");\n  document.body.appendChild(app);\n};\n\nconst useSetup = function (module) {\n  module.default.setup();\n};\n\n\n//# sourceURL=webpack://spa/./src/js/utils.js?");
